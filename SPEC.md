...
- MAY be unquoted only if they match: ^[A-Za-z\_][A-Za-z0-9_.]\*$.
...
- Keys and colon syntax: MUST conform to §7.2 (unquoted keys match ^[A-Za-z\_][A-Za-z0-9_.]\*$; quoted otherwise; colon required after keys).
